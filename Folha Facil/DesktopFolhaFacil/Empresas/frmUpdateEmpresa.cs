...
namespace PrototipoRH.Empresas
{
    public partial class frmAtualizarEmpresa : Form
    {
        ...
        private void frmAtualizarEmpresa_Load_1(object sender, EventArgs e)
        {
        ...
        private void btnAtualizarEmpresa_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnLimparEmpresa_Click_1(object sender, EventArgs e)
        {
            txtEmpresa.Text = "";
            mskCnpj.Text = "";
            msktxtTelefone.Text = "";
